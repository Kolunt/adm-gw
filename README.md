...
Подробная инструкция по развертыванию находится в документации:
- [Быстрый старт](docs/PYTHONANYWHERE_QUICK_START.md)
- [Полная инструкция](docs/PYTHONANYWHERE_DEPLOYMENT.md)
- [Автоматизация](docs/PYTHONANYWHERE_AUTOMATION.md)
