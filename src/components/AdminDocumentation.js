...
const AdminDocumentation = () => {
  ...
  return (
    <div className={isDark ? 'dark-theme' : 'light-theme'} style={{ padding: '24px' }}>
      ...
      <ProCard style={{
        ...
        <Collapse
          ...
          items={documentationSections.map((section) => ({
            key: section.key,
            label: (
              <Text strong style={{ fontSize: '16px', color: isDark ? '#ffffff' : '#000000' }}>
                {section.label}
              </Text>
            ),
      ...
      <ProCard 
        title={<span style={{ color: isDark ? '#ffffff' : '#000000' }}>Быстрые ссылки</span>} 
        style={{ 
          marginTop: '24px',
          backgroundColor: isDark ? '#1f1f1f' : '#ffffff',
          border: isDark ? '1px solid #404040' : '1px solid #d9d9d9'
        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} md={8}>
            <Card size="small" style={{ 
              ...
              <TeamOutlined style={{ fontSize: '24px', color: isDark ? '#52c41a' : '#2d5016', marginBottom: '8px' }} />
              <div>
                <Text strong style={{ color: isDark ? '#ffffff' : '#000000' }}>Пользователи</Text>
                <br />
                <Text type="secondary" style={{ color: isDark ? '#bfbfbf' : '#8c8c8c' }}>Управление участниками</Text>
              </div>
            </Card>
          </Col>
          <Col xs={24} md={8}>
            <Card size="small" style={{ 
              ...
              <CalendarOutlined style={{ fontSize: '24px', color: isDark ? '#52c41a' : '#52c41a', marginBottom: '8px' }} />
              <div>
                <Text strong style={{ color: isDark ? '#ffffff' : '#000000' }}>Мероприятия</Text>
                <br />
                <Text type="secondary" style={{ color: isDark ? '#bfbfbf' : '#8c8c8c' }}>Создание событий</Text>
              </div>
            </Card>
          </Col>
          <Col xs={24} md={8}>
            <Card size="small" style={{ 
              ...
              <GiftOutlined style={{ fontSize: '24px', color: isDark ? '#faad14' : '#faad14', marginBottom: '8px' }} />
              <div>
                <Text strong style={{ color: isDark ? '#ffffff' : '#000000' }}>Подарки</Text>
                <br />
                <Text type="secondary" style={{ color: isDark ? '#bfbfbf' : '#8c8c8c' }}>Назначения подарков</Text>
              </div>
            </Card>
          </Col>
        </Row>
